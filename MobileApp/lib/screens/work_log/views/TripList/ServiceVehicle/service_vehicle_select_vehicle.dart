...
class ServiceVehicleSelectVehicle extends StatefulWidget {
  const ServiceVehicleSelectVehicle({super.key});

  @override
  State<StatefulWidget> createState() =>
      _ServiceVehicleSelectVehicle();
}

class _ServiceVehicleSelectVehicle
    extends State<ServiceVehicleSelectVehicle> {
