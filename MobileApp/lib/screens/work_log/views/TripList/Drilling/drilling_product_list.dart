    ...
    if (allReports.isEmpty) {
      ...
      if (result['status'] == 'success') {
        ...
        for (var reportJson in data) {
          ...
          report.localKey =
              "DRILL_${report.orderId}_${report.device?.id}_${report.material?.id}_${report.drillDepth}_${report.hardnessF}";
    ...
    for (var report in reports) {
      try {
        ...
        final payload = {
          ...
          "drillDepth": report.drillDepth,
          "hardnessF": report.hardnessF,
        };
        ...
        actions: [
          IconButton(
            onPressed: () {
              Navigator.pushNamed(
                context,
                WorkLogRoutes.drillingSelectVehicle,
              );
            },
