...
class DirectWorkDrilling extends StatefulWidget {
  final OrderModel order;
  const DirectWorkDrilling({
    super.key,
    required this.order,
  });
  @override
...
class _DirectWorkDrilling
    extends State<DirectWorkDrilling> {
  UserModel? user;
  ...
  void create() async {
    ...
    for (var entry in _vehicleControllers.entries) {
      ...
      vehiclesReport.add({
        ...
        "hardness": int.tryParse(controller.hardness.text),
      });
    }
