...
class ExcavatorButton extends StatefulWidget {
  final String? vehicle;
  final Function(String) onSelectVehicle;
  const ExcavatorButton({
    super.key,
    this.vehicle,
...
class _ExcavatorButton extends State<ExcavatorButton> {
      ...
      child: TextButton.icon(
        ...
        onPressed: () async {
          final selectedVehicle = await Navigator.of(
            context,
            rootNavigator: true,
          ).pushNamed(AppRoute.excavatorSelect);
