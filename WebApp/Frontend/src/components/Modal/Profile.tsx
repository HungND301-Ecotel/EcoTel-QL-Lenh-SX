...
import {
    ...
    TextField, MenuItem, Grid, Autocomplete, Typography
} from '@mui/material'
    ...
    return (
        <Dialog open={open} onClose={handleClose} maxWidth="md" fullWidth>
            ...
            <DialogContent>
                <Box component="form" onSubmit={formik.handleSubmit} sx={{ mt: 2 }}>
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                        ...
                        <TextField fullWidth select name="gender" label="Giới tính"
                        ...
                        <TextField fullWidth name="phone" label="Số điện thoại"
            ...
            <DialogActions>
                ...
                <Button variant="contained" onClick={() => formik.handleSubmit()}>Cập nhật</Button>
            </DialogActions>
        </Dialog>
    )
}
