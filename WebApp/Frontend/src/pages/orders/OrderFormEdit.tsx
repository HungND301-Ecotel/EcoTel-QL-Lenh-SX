  ...
  const formik = useFormik({
    initialValues: {
      ...
      device: Array.isArray(initialValues.device)
        ? initialValues.device.map((d: any) =>
            typeof d === "object" ? d?._id : d,
          )
        : initialValues.device
          ? [
              typeof initialValues.device === "object"
                ? initialValues.device?._id
                : initialValues.device,
            ]
          : [],
      ...
      location: Array.isArray(initialValues.location)
        ? initialValues.location.map((d: any) =>
            typeof d === "object" ? d?._id : d,
          )
        : initialValues.location
          ? [
              typeof initialValues.location === "object"
                ? initialValues.location._id
                : initialValues.location,
            ]
          : [],
      material: Array.isArray(initialValues.material)
        ? initialValues.material.map((d: any) =>
            typeof d === "object" ? d?._id : d,
          )
        : initialValues.material
          ? [
              typeof initialValues.material === "object"
